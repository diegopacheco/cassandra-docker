...
function setupCluster(){
  ...
  docker run -d -v $SHARED --net myDockerNetCassandra --ip 178.18.0.101 --name cassandra1 -p 32101:9060 -p 9042:9042 -e CASS_VERSION=$CV diegopacheco/cassandradocker
